...
Интересно сможет ли nvidia сделать драивер лучше пока остается в воздухе , но для работы как я понял отсюда https://github.com/NVIDIA/nvidia-docker инструменты есть
